...
fn mm_book() {
    ...
    res.assert_event(&Event::new("wasm-rujira-fin/trade").add_attributes(vec![
        ("rate", "1001.0061"),
        ("price", "mm:1001.006011041096301783"),
        ("offer", "100000000"),
        ("bid", "99899"),
        ("side", "base"),
    ]));
    ...
    res.assert_event(&Event::new("wasm-rujira-fin/trade").add_attributes(vec![
        ("rate", "1000.0002"),
        ("price", "mm:1000.000240120060030015"),
        ("offer", "199900"),
        ("bid", "199900048"),
        ("side", "quote"),
    ]));
    ...
    res.assert_event(&Event::new("wasm-rujira-fin/trade").add_attributes(vec![
        ("rate", "998.00324"),
        ("price", "mm:998.003243394519712742"),
        ("offer", "200099"),
        ("bid", "199699451"),
        ("side", "quote"),
    ]));
    res.assert_event(&Event::new("wasm-rujira-fin/trade").add_attributes(vec![
        ("rate", "996.01022"),
        ("price", "mm:996.010229655516724912"),
        ("offer", "100001"),
        ("bid", "99602018"),
        ("side", "quote"),
    ]));
...
fn combined_book() {
    ...
    res.assert_event(&Event::new("wasm-rujira-fin/trade").add_attributes(vec![
        ...
        ("price", "mm:99700.598951048951048951"),
        ("side", "quote"),
    ]));
    res.assert_event(&Event::new("wasm-rujira-fin/trade").add_attributes(vec![
        ("rate", "99600"),
    ...
    res.assert_event(&Event::new("wasm-rujira-fin/trade").add_attributes(vec![
        ("rate", "99501.496"),
        ("price", "mm:99501.496506986027944111"),
        ("offer", "3975"),
        ("bid", "395518448"),
        ("side", "quote"),
    ]));
    ...
    let order: OrderResponse = app
        ...
        .unwrap();
    assert_eq!(order.filled, Uint128::from(503u128));
